...
export const ENEMIES: EnemyDef[] = [
  ...
  },
  {
    ...
    color: 0xcc00ff, moveType: 'slow_descent', attackType: 'aimed_single', attackInterval: 1500,
    hp: 4, exp: 15, coin: 2,
    specialDropFlag: false, specialDropType: 'none', specialDropChance: 0,
  ...
  // ====== 拡張敵 (特殊ドロップ持ち) ======
  {
    ...
    color: 0xff00ff, moveType: 'slow_descent', attackType: 'spread3', attackInterval: 2000,
    hp: 8, exp: 30, coin: 5,
  ...
  },
  {
    ...
    color: 0xaa00aa, moveType: 'slow_descent', attackType: 'circle8', attackInterval: 3000,
    hp: 12, exp: 50, coin: 8,
